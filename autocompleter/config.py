...
class Config:
    ...
    # Feedback reporting (bug / context-extraction-issue hotkey)
    feedback_webhook_url: str = ""  # Empty disables webhook; reports are still saved locally.
...
def load_config() -> Config:
    ...
    config = Config(
        ...
        feedback_webhook_url=os.environ.get("AUTOCOMPLETER_FEEDBACK_URL", ""),
